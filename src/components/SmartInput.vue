    ...
    <div class="friendSearchContainer">
            ...
            >
                <ul class="smartInput-badge-list">
                    <li v-for="(item,index) in selected" :key="index" class="smartInput-badge">
                        <span>{{item}}</span>
            ...
            <ul v-show="searching" class="friendSearchList">
                ...
                <li v-else v-for="(item, index) in filtered" :key="index" :class="{'smartInput-active': selected.includes(item)}" @click.stop="clickOne" @mouseover="hoverOn">
                    {{ item }}
                </li>
            </ul>
